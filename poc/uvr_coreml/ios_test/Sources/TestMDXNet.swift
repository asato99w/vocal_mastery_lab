...
func runMDXNetTest() throws {
    print(String(repeating: "=", count: 60))
    print("🎵 MDXNet ボーカル分離テスト")
    print(String(repeating: "=", count: 60))
    ...
    // モデル初期化
    let separator = try MDXNetSeparator(modelURL: modelPath)
...
private func saveAudio(_ samples: [Float], to url: URL, sampleRate: Int) throws {
