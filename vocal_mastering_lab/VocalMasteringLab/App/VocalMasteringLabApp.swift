...
@main
public struct VocalMasteringLabApp: App {
    private static let boot = Logger(
        subsystem: "com.kazuasato.VocalMasteringLab",
        category: "boot"
    )
    ...
    public init() {
        ...
        FileLogger.shared.log(level: "INFO", category: "system", message: "VocalMasteringLab started")
